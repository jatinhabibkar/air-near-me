...
const BarLine = (props) => {
    ...
    function getDayNow(date){
        ...
        if(data.getDate() === today.getDate()){
            return <div className="date" style={{color:"black"}}>{arrayOfWeekdays[ data.getDay()]}</div>
        }
...
return (<React.Fragment>
            <div className="item">
                <div className="barline" title={props.min +"-" +props.max} style={{"height":(props.number<201 ? props.number : 200)}}></div>
